...
WatchFaceMattZ::WatchFaceMattZ(Controllers::DateTime& dateTimeController,
  ...
  lv_obj_set_style_local_text_color(label_day, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::white);
  lv_obj_align(label_day, lv_scr_act(), LV_ALIGN_CENTER, 0, -80);

  label_date = lv_label_create(lv_scr_act(), nullptr);
  lv_obj_align(label_date, lv_scr_act(), LV_ALIGN_CENTER, 0, -50);
  lv_obj_set_style_local_text_color(label_date, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::white);
