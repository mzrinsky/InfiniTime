...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(iosevka_mono_20) \
                               LV_FONT_DECLARE(iosevka_mono_80) \
                               LV_FONT_DECLARE(iosevka_mono_42) \
                               LV_FONT_DECLARE(iosevka_mono_76) \
...
#define LV_THEME_DEFAULT_FONT_SMALL         &iosevka_mono_20
#define LV_THEME_DEFAULT_FONT_NORMAL        &iosevka_mono_20
#define LV_THEME_DEFAULT_FONT_SUBTITLE      &iosevka_mono_20
#define LV_THEME_DEFAULT_FONT_TITLE         &iosevka_mono_20
